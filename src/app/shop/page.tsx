        ...
        <main className='grid lg:grid-cols-11 md:grid-cols-11 grid-cols-1 w-full gap-8'>
            <article className='lg:col-span-7 md:col-span-7 sm:col-span-11 col-span-11 mb-12'>
                ...
                <div className='flex justify-between mb-20'>
                    <div className='w-[260px] h-[42px] border px-[20px] text-[14px] py-[7px] text-headingcolor font-jost'>
                        <p>SHOWING 1-8 OF 20 RESULTS</p>
                    </div>
                    <select className='w-[260px] h-[42px] border px-[20px] py-[7px] text-headingcolor font-jost focus:outline-none lg:text-[14px] md:text-[12px] text-[10px]' >
                        <option defaultValue="" disabled selected>DEFAULT SORTING</option>
            ...
            <aside className='lg:col-span-4 md:col-span-4 col-span-11 w-full bg-blue-400'>g</aside>
        </main>
    </section>
  )
}
